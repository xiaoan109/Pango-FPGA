# 小麻雀处理器
[![rvlogo](/sparrow_soc/src/SparrowRV/doc/图库/Readme/rvlogo.bmp)RISC-V官网收录](https://riscv.org/exchange/?_sf_s=sparrowrv)  
[![teelogo](/sparrow_soc/src/SparrowRV/doc/图库/Readme/giteetj.bmp)Gitee推荐项目](https://gitee.com/explore/risc-v)  
[![book](/sparrow_soc/src/SparrowRV/doc/图库/Readme/book.png)处理器文档导航页](/sparrow_soc/src/SparrowRV/doc/文档导航.md)  
...
详细内容及使用教程请参阅[**处理器文档导航页**](/sparrow_soc/src/SparrowRV/doc/文档导航.md)  

## 工程组织框架
小麻雀处理器包含了RTL、软件、硬件设计。  
![组织框架](/sparrow_soc/src/SparrowRV/doc/图库/Readme/工程结构.svg)  
